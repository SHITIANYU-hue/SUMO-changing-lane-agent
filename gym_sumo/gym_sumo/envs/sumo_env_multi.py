...
class SumoEnv_multi(gym.Env):
	...
	def start(self, gui=False, numVehicles=10, num_rl=3, vType='human', network_conf="networks/highway/sumoconfig.sumo.cfg", network_xml='networks/highway/highway.net.xml'):
		self.gui = gui
