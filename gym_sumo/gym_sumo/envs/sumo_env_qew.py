...
class SumoEnv_qew(gym.Env):
	...
	def start(self, gui=False, numVehicles=10, warm_up=50,vType='human', network_conf="networks/sumo_qew/sumoconfig.sumo.cfg", network_xml='networks/sumo_qew/qew.net.xml'):
		self.gui = gui
		...
		# 	traci.vehicle.add(veh_name, routeID='4304', typeID=self.vType, departLane='random')
		...
		for step in range(self.warmup):
			traci.simulationStep()

		traci.vehicle.add(self.name, routeID='4304', typeID='rl')
