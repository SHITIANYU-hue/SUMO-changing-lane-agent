...
class SumoEnv_merge(gym.Env):
	...
	def start(self, gui=False, numVehicles=10, warm_up=50, vType='human', network_conf="networks/merge_qew/sumoconfig.sumo.cfg", network_xml='networks/merge_qew/qew_mississauga_rd.net.xml'):
		self.gui = gui
		...
		traci.vehicle.add(self.name, routeID='route_1', typeID='rl', departLane='0',departPos=500,departSpeed=15)
